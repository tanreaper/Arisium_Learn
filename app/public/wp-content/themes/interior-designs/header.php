			...
			<div class="container">
				<div id="header" class="row">
					<div class="menubox nav p-lg-0 p-2 col-lg-11 col-md-11 col-10">
				              ...
				              <button role="tab" onclick="interior_designs_menu_open()"><i class="<?php echo esc_html(get_theme_mod('interior_designs_responsive_open_menu_icon','fas fa-bars')); ?>"></i><?php echo esc_html( get_theme_mod('interior_designs_open_menu_label', __('Open Menu','interior-designs'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','interior-designs'); ?></span></button>
				            </div>
				        <?php ?>
			            <div id="menu-sidebar" class="nav side-menu pt-lg-0 pt-5">
				            <nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'interior-designs' ); ?>">
				                <?php 
				                 ...
				                 ?>
				                <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="interior_designs_menu_close()"><?php echo esc_html( get_theme_mod('interior_designs_close_menu_label', __('Close Menu','interior-designs'))); ?><i class="<?php echo esc_html(get_theme_mod('interior_designs_responsive_close_menu_icon','fas fa-times'));?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','interior-designs'); ?></span></a>
				            </nav>
			            </div>
						<div class="clear"></div>
					</div>
